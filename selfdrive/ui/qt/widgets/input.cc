...
bool ConfirmationDialog::alert(const QString &prompt_text, QWidget *parent) {
  ...
  ConfirmationDialog d = ConfirmationDialog(prompt_text, "تأكيد", "", parent);
  return d.exec();
}
...
bool ConfirmationDialog::confirm(const QString &prompt_text, QWidget *parent) {
  ...
  ConfirmationDialog d = ConfirmationDialog(prompt_text, "تأكيد", "الغاء", parent);
  return d.exec();
}
...
bool RichTextDialog::alert(const QString &prompt_text, QWidget *parent) {
  ...
  auto d = RichTextDialog(prompt_text, "تأكيد", parent);
  return d.exec();
}
